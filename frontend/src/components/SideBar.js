...
const SideBar = () => {
  ...
  return (
    <div>
      <div
        id="Main"
        className="fixed t-0 xl:rounded-r transform  xl:translate-x-0  ease-in-out transition duration-500 flex justify-start items-start h-full  
                       w-full sm:w-64 bg-gray-900 flex-col"
      >
        <div className="hidden xl:flex justify-start p-6 items-center space-x-3">
          ...
          <p className="text-2xl leading-6 text-white">Chicken App</p>
        </div>
          ...
          {buttons.map((button) => {
            return (
              <div className="flex flex-col justify-start items-center px-6 border-b border-gray-600 w-full">
                <button
                  value={button.Name}
                  onClick={(e) => openSideBarFunction(e)}
                  className="z-50 focus:outline-none focus:text-indigo-400 text-left  text-white flex justify-between items-center w-full py-5 space-x-14  "
                >
                  <p className="text-sm leading-5  uppercase">{button.Name}</p>
                </button>
                <div
                  id="menu1"
                  className={
